                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0">ADMIN MANAGEMENT</h3>
                                                <small class="text-muted">VIVEKANDHA</small>
                                                <div class="staff-id">COLLEGE ID : 0051123</div>
                                                <div class="staff-msg"><a href="add_notification.php" class="btn btn-primary">Send Notification</a></div>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                ...
                                                <li>
                                                    ...
                                                    <span class="text"><a href="#">viv@gmail.com</a></span>
                                                </li>
